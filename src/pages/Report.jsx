...
function Report() {
  ...
  return (
    <div className="flex flex-col">
      ...
      >
        <CardeCom
          sum={data ? data.chatCount : "0"}
          title="تعداد چت"
          discount="0"
          iconsTitle={
            <IoChatboxEllipsesOutline className="text-5xl mr-16 p-2 bg-blue-700 rounded-full text-white" />
          }
        />
        <CardeCom
          sum={data ? data.productCount : "0"}
          title="تعداد محصولات"
          discount="0"
          iconsTitle={
            <FaShoppingBasket className="text-5xl p-2 bg-blue-700 rounded-full text-white" />
          }
        />
      </SimpleGrid>
      {/* TABEL CONTENT */}
                ...
                <table className="min-w-full">
                  ...
                  <tbody className="border-2">
                    ...
                    >
                      <td
                        className={
                          "text-center py-4 whitespace-nowrap text-sm font-medium border-l border-gray-400 " +
                          (colorMode === "light"
                            ? "bg-gray-300"
                            : "bg-[#1a202c]")
                        }
